...
class AE:
    def __init__(self, input_dim, n_components, dataset_name, input_type, hidden_layers_sizes=()):
    ...
    def train(self, data, batch_size=1024):
        tf_dataset = tf.data.Dataset.from_tensor_slices((data, data))
        tf_dataset = tf_dataset.batch(batch_size)
        tf_dataset = tf_dataset.shuffle(batch_size * 20)
